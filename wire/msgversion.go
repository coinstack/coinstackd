...
// AddNodeSign adds a publickey and compressed address of self to the user agent
// string.
func (msg *MsgVersion) AddNodeSign(signature string) error {
	//TODO address or pubkey must be attached
	msg.UserAgent = fmt.Sprintf("%ssign:%s/", msg.UserAgent,
		signature)
	return nil
}
