...
// defaultMaxBlockPayload is the default value of maximum bytes a block message can be in bytes.
const defaultMaxBlockPayload = 20971520 // Not actually 20MB which would be 1024 * 1024

// MaxBlockPayload returns the maximum bytes a block message can be in bytes.
var MaxBlockPayload uint32 = defaultMaxBlockPayload
