...
var helpDescsEnUS = map[string]string{
	...
	// CheckPermissionCmd help.
	"checkpermission--synopsis":  "",
	"checkpermission-address":    "",
	"checkpermission-permission": "",
	"checkpermission--result0":   "",
	...
	// NotifyInvCmd help.
	"notifyinv--synopsis": "Request notifications for outgoing inv messages.",
}
